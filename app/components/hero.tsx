  ...
  return (
    <section className={`container ${styles.hero}`}>
      ...
      <div className={styles.introBottom}>
        <p className='paragraphMd'>{`I’m a full-stack experience designer specialising in e-commerce and fintech, with a track record of roles in Product Design, Product Management, and Design Leadership. A builder at heart, I thrive when I'm crafting complex products from 0→1, while establishing and driving high-performing design teams.`}</p>
      </div>
    </section>
  );
};
